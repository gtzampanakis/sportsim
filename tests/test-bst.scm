...
(define-public (test-bst-delete! test-fns)
  ...
  (set! bst (bst-proc 'add! bst 8))
  (set! bst (bst-proc 'add! bst 9))
  (set! bst (bst-proc 'add! bst 10))
  (set! bst (bst-proc 'add! bst 11))
  (set! bst (bst-proc 'add! bst 12))
  (set! bst (bst-proc 'add! bst 13))
  (set! bst (bst-proc 'add! bst 14))
